...
/**
 * Looked up by id (not slug) — for any server-side caller that only has a
 * product id and must independently re-derive real product data from the
 * database, never trusting anything a client sends.
 */
