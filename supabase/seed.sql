...
('How do I order?', 'Select a product and variation, review the price and specifications, then use the "Order via Telegram" button. This opens a pre-filled message to our support team with your selected product, variation and price.', 'Ordering', 4),
...
('How can I contact support?', 'The fastest way to reach us is via Telegram — use the "Contact Support" or "Order via Telegram" buttons found throughout the site.', 'General', 11)
